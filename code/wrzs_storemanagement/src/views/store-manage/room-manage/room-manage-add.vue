      ...
      <el-col :span="24">
        <el-form ref="form" :model="form" :rules="formRules" label-width="120px">
          ...
          <el-form-item label="已售" prop="room_sold">
            <el-input-number v-model="form.room_sold" :precision="0" :step="1" :min="0"
          ...
          <el-form-item label="房间展示图">
            <el-upload :action="uploadURL" list-type="picture-card" multiple :limit="5" :on-remove="removeBatchUpload"
                       :before-upload="beforeUpload"     :on-success="batchUploadSuccess">
              <i class="el-icon-plus"></i>
            </el-upload>
...
export default {
  ...
  methods: {
    ...
    removeBatchUpload(res) {
      const idx = this.form.room_images.indexOf(res.response.data)
