<template>
  <div class="sell-drawer-manage-add">
...
import {addSellDrawer} from "@/api/sell-drawer-manage/sell-drawer-manage"

export default {
  name: "sell-drawer-manage-add",
  data() {
    // 验证空
  ...
  methods: {
    ...
    submit() {
      this.$refs['form'].validate(async valid => {
        if (valid) {
          await addSellDrawer(this.form).then(() => {
