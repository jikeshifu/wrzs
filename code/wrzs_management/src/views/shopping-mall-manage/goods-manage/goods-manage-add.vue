<template>
  <div class="goods-manage-add">
    <el-row>
      <el-col>
        <el-form ref="form" :model="form" :rules="formRules" label-width="120px">
          <el-form-item label="商品主图" prop="goods_image">
            <el-upload :action="uploadURL" :before-upload="beforeUpload" list-type="picture-card" :limit="1"
...
export default {
  ...
  methods: {
    ...
    // 上传图片成功的钩子
    uploadSuccess(res) {
      console.log('https://rrt-server.seekr.cc/' + res.data)
